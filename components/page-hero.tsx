...
export function PageHero({ eyebrow, title, description, primaryCta, secondaryCta }: PageHeroProps) {
  return (
    <section className="grain overflow-hidden bg-charcoal bg-mesh text-soft">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1.25fr_0.75fr] lg:px-10 lg:py-32">
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            <p className="max-w-2xl text-base leading-8 text-stone sm:text-lg">{description}</p>
          </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {secondaryCta ? (
                <Link
                  ...
                  className="rounded-full border border-soft/25 px-6 py-3 text-sm font-medium text-soft transition hover:border-soft hover:bg-soft/10"
                >
                  {secondaryCta.label}
                </Link>
              ) : null}
        ...
        <div className="card-surface border-soft/10 bg-soft/5 p-8 shadow-aura">
